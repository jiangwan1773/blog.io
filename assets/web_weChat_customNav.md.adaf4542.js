import{_ as n,C as a,c as l,H as p,Q as o,o as t}from"./chunks/framework.c3d9f2ac.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"web/weChat/customNav.md","filePath":"web/weChat/customNav.md"}'),e={name:"web/weChat/customNav.md"},c=o(`<h2 id="代码" tabindex="-1">代码 <a class="header-anchor" href="#代码" aria-label="Permalink to &quot;代码&quot;">​</a></h2><div class="info custom-block"><p class="custom-block-title">一、html部分</p><div class="language-html vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 封装顶部Nav组件 --&gt;</span></span>
